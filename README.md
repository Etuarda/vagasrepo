...
O formulario de analise salva cargo, empresa, link e descricao da vaga em `JobAnalysis`. A analise e o curriculo otimizado permanecem acessiveis no historico por 30 dias; ao consultar o historico, registros vencidos e PDFs otimizados sem analises ativas sao removidos. Uma candidatura persistida permanece independente desse prazo; quando disponivel, o link salvo e preenchido automaticamente no cadastro de acompanhamento.
